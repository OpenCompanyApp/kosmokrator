...
#[AsCommand(name: 'mcp:call', description: 'Call an MCP function headlessly')]
final class McpCallCommand extends Command
{
    ...
    protected function configure(): void
    {
        ...
        $this
            ...
            ->addOption('dry-run', null, InputOption::VALUE_NONE, 'Validate resolution, trust, arguments, and permissions without executing');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $tokens = $this->tokensAfterFunction($this->rawTokens($input), $name, $payload);
