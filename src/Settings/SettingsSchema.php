...
final class SettingsSchema
{
    ...
    private function buildDefinitions(): array
    {
        ...
        $definitions = [
            ...
            new SettingDefinition(
                id: 'gateway.telegram.admin_users',
                path: 'kosmo.gateway.telegram.admin_users',
                label: 'Admin users',
                description: 'Space- or comma-separated Telegram user IDs or usernames allowed to press global control buttons and approve any request.',
                category: 'gateway',
                type: 'string_list',
                effect: 'next_session',
                default: [],
            ...
            new SettingDefinition(
                id: 'gateway.telegram.reply_to_mode',
                path: 'kosmo.gateway.telegram.reply_to_mode',
                label: 'Reply mode',
                description: 'Whether answer chunks reply to the original Telegram message.',
                category: 'gateway',
                type: 'choice',
            ...
            new SettingDefinition(
                id: 'gateway.telegram.disable_link_previews',
                path: 'kosmo.gateway.telegram.disable_link_previews',
                label: 'Disable link previews',
                description: 'Disable Telegram link previews for gateway messages.',
                category: 'gateway',
                type: 'toggle',
                options: ['on', 'off'],
                effect: 'next_session',
            ...
            new SettingDefinition(
                id: 'gateway.telegram.fresh_final_after_seconds',
                path: 'kosmo.gateway.telegram.fresh_final_after_seconds',
                label: 'Fresh final threshold',
                description: 'Send a fresh final message after this many seconds of streamed edits. Set 0 to disable.',
                category: 'gateway',
                type: 'number',
                effect: 'next_session',
                default: 60,
            ...
            new SettingDefinition(
                id: 'gateway.telegram.progress_notice_interval_seconds',
                path: 'kosmo.gateway.telegram.progress_notice_interval_seconds',
                label: 'Progress notice interval',
                description: 'Minimum seconds between long-running Telegram progress status updates. Set 0 to disable.',
                category: 'gateway',
                type: 'number',
                effect: 'next_session',
                default: 60,
            ...
            new SettingDefinition(
                id: 'gateway.telegram.reactions',
                path: 'kosmo.gateway.telegram.reactions',
                label: 'Message reactions',
                description: 'Use Telegram reactions to mark processing and completion when supported.',
                category: 'gateway',
                type: 'toggle',
                options: ['on', 'off'],
                effect: 'next_session',
