...
final class ToastManagerTest extends TestCase
{
    ...
    public function testStaticShow(): void
    {
    ...
    public function testMaxVisibleDismissesOldest(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testDismissToast(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testDismissToastAlreadyExiting(): void
    {
        $manager = ToastManager::getInstance();
        $toast = $manager->addToast(new ToastItem('Test', ToastType::Info));
    ...
    public function testDismissAll(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testStaticDismissAll(): void
    {
        ToastManager::info('A');
        ToastManager::info('B');
    ...
    public function testRemoveToast(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testEntranceAnimationSetsInitialState(): void
    {
        $manager = ToastManager::getInstance();
        $toast = $manager->addToast(new ToastItem('Test', ToastType::Info));
    ...
    public function testDesktopBridgeOnError(): void
    {
    ...
    public function testNoDesktopBridgeOnSuccess(): void
    {
    ...
    public function testDesktopBridgeCanBeDisabled(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testGetToastAtReturnsNullForEmptyStack(): void
    {
        $manager = ToastManager::getInstance();
    ...
    public function testGetToastAtReturnsNullForMiss(): void
    {
        $manager = ToastManager::getInstance();
