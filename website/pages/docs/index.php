...
$topics = [
    ...
    'termux' => ['Termux (Android)', 'Install and run KosmoKrator on Android with Termux, PHP, Composer, and provider credentials.', '&#x1F4F1;'],
    ...
    'sdk' => ['Agent SDK', 'Embed the headless runtime in PHP apps with structured events, sessions, permissions, integrations, MCP, and Lua.', '&#x1F4E6;'],
    'integrations' => ['Integrations CLI', 'Headless OpenCompany integrations for scripts, coding CLIs, and Lua workflows.', '&#x1F517;'],
    'mcp' => ['MCP', 'Portable .mcp.json servers, headless MCP calls, resources, prompts, and Lua app.mcp workflows.', '&#x1F9E9;'],
    'acp' => ['ACP', 'Wrap KosmoKrator from editors and non-PHP apps through Agent Client Protocol plus KosmoKrator extensions.', '&#x1F5A7;&#xFE0F;'],
