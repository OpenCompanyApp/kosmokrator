                    ...
                    <div class="install-panel active" id="tab-binary">
                        <div class="quickstart-code" style="border-radius: 0 0 14px 14px; border-top: none;">
                            <div class="terminal-body">
                                <div class="terminal-line"><span class="code-comment"># Auto-detects OS &amp; arch, downloads ~25MB static binary</span></div>
                                <div class="terminal-line" style="margin-top:0.75rem"><span class="prompt">$</span> <span class="command">curl -fsSL https://raw.githubusercontent.com/OpenCompanyApp/kosmokrator/main/install.sh | bash</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="install-panel" id="tab-phar">
                        <div class="quickstart-code" style="border-radius: 0 0 14px 14px; border-top: none;">
                            <div class="terminal-body">
                                ...
                                <div class="terminal-line" style="margin-top:0.5rem"><span class="prompt">$</span> <span class="command">sudo curl -fSL https://github.com/OpenCompanyApp/kosmokrator/releases/latest/download/kosmokrator.phar \</span></div>
