...
{"type":"tool_progress","output":"src/Agent/AgentLoop.php\n...","timestamp":1712570006500}
...
| `tool_progress` | Incremental tool output preview, currently emitted for streaming bash output |
