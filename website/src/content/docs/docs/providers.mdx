...
The bundled catalog includes current top entries such as OpenAI `gpt-5.5`, Anthropic `claude-opus-4-8`, Gemini `gemini-3.1-pro-preview`, Kimi `kimi-k2.7-code`, MiniMax `MiniMax-M3`, and Z.AI `glm-5.2`. Select `glm-5.2` with provider `z` for the Z.AI coding endpoint.
