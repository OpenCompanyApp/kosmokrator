...
| Path | Scope | Notes |
| --- | --- | --- |
| `.kosmo/skills/&lt;name&gt;/SKILL.md` | project | Canonical project-local path. |
| `.agents/skills/&lt;name&gt;/SKILL.md` | project | Ecosystem-compatible project path. |
| `~/.kosmo/skills/&lt;name&gt;/SKILL.md` | user | Personal global skills. |
...
| `$create &lt;name&gt;` | Create a project skill template under `.kosmo/skills`. |
